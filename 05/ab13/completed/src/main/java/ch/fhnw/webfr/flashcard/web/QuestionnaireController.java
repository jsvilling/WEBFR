...
public class QuestionnaireController {
    ...
    public String create(@Valid Questionnaire questionnaire, BindingResult bindingResult) {
        if (bindingResult.hasErrors()) {
            ...
            // Model is already available over the input parameter as "questionnaire". It will be
            // returned automatically to the templating framework by SpringMVC and
            // doesn't have to be set as attribute!
            return "questionnaires/create";
        }
